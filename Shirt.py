...
def run(s):
    imgshirt=cv2.imread("C://Users//pjain//Desktop//AR PROJECT//final//tshirt//"+s)
    face_cascade=cv2.CascadeClassifier(r'C:\opencv\sources\data\haarcascades\haarcascade_frontalface_alt2.xml')
    ...
    while True:
        ...
        if key & 0xFF == ord('c'):  # save on pressing 'c'
            ...
            while j>=10:
                ...
                cv2.imwrite('C:/Users/pjain/Desktop/AR PROJECT/final/Captures/'+str(rand)+'.png', img)
